 ...
 */
class WC_Widget_Custom_Layered_Nav extends WC_Widget {
...
//			echo '<form method="get" action="' . esc_url( $form_action ) . '" class="woocommerce-widget-layered-nav-dropdown">';
			...
			echo '<select id="'.esc_attr( $taxonomy_filter_name ).'" class="form-control woocommerce-widget-layered-nav-dropdown dropdown_layered_nav_' . esc_attr( $taxonomy_filter_name ) . '"' . ( $multiple ? 'multiple="multiple"' : '' ) . '>';
			...
			echo '</select>';
            echo '<label class="form-label" for="'.esc_attr( $taxonomy_filter_name ).'">'.ucfirst(esc_attr( $taxonomy_filter_name )).'</label>';
            echo '</div>';
			/*if ( $multiple ) {
				echo '<button class="woocommerce-widget-layered-nav-dropdown__submit btn btn-primary" type="submit" value="' . esc_attr__( 'Apply', 'woocommerce' ) . '">' . esc_html__( 'Apply', 'woocommerce' ) . '</button>';
			}
