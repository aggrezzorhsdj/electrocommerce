            ...
            <div class="col-md-6">
                <div class="mb-4">
                    <div class="form-floating">
                        ...
                        <label class="form-label" for="account_first_name"><?php esc_html_e('First name', 'woocommerce'); ?>
                ...
                <div class="mb-4">
                    <div class="form-floating">
                        ...
                        <label class="form-label" for="account_last_name"><?php esc_html_e('Last name', 'woocommerce'); ?>
                            &nbsp;<span class="required">*</span></label>
                    </div>
                </div>
                <div class="clear"></div>
                ...
                <div class="mb-4">
                    <div class="form-floating">
                        ...
                        <label class="form-label" for="account_email"><?php esc_html_e('Email address', 'woocommerce'); ?>
                            &nbsp;<span class="required">*</span></label>
                    </div>
                </div>
            </div>
